...
- やろうという議論が出てきたわけではない
  ...
  - `deno coverage`の変更もRyanさんは渋っているけど、LucaさんMarvinさんなどJSをよく使っているコアメンバーは好意的
...
- ファクトリー関数は最近のJSのAPIだとなくなる傾向にあると教わった
  ...
  - `Deno.Command`は最初`Deno.command`としてファクトリー関数だったけど、[Luca](https://github.com/lucacasonato)さんの発言からclass宣言に変わった
...
- ランダム10名に100ドル分の[Deno Merch](https://merch.deno.com)のチケットを渡す
  - uhyoさんがもらってたね<!-- TODO: 情報が見当たらなかった -->
...
### I/Oインターフェイスの非推奨化
- [denops.vim](https://github.com/vim-denops/denops.vim)内の双方向通信にReader/Writerでプロトコルを書いている
- kuuさんがStream APIに書き換えたら色々と動かなくなってしまった <!-- TODO: 見当たらなかった、Slackで話されていたShugoさんのお話？ -->
